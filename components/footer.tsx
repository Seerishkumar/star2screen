    ...
    <footer className="bg-primary text-white">
      <div className="container px-4 py-10 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <div className="mb-4">
              <Image src="/main-logo.png" alt="Stars2Screen Logo" width={180} height={50} className="h-12 w-auto" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/categories/actors" className="text-sm hover:underline">
                  Actors
                </Link>
              </li>
              <li>
                <Link href="/categories/directors" className="text-sm hover:underline">
                  Directors
                </Link>
              </li>
              <li>
                <Link href="/categories/producers" className="text-sm hover:underline">
                  Producers
                </Link>
              </li>
              <li>
