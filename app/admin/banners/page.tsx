...
import { Shield, ImageIcon, ArrowLeft } from "lucide-react"
...
export default function BannerManagementPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Check if user has banner management permissions
      if (!["super_admin", "admin", "content_admin"].includes(user.role)) {
        toast({
          title: "Access Denied",
          description: "You don't have permission to access banner management",
          variant: "destructive",
        })
        router.push("/admin")
        return
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage homepage banners and promotions</p>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create, edit, and manage homepage banners and promotional content
            </CardDescription>
          </CardHeader>
          <CardContent>
            <BannerManagement />
